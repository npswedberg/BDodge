...
public:
	...
	bone *parent = NULL;
	vector<bone*> kids;			
	int index;			//a unique number for each bone, at the same time index of the animatiom matrix array
	...
	void write_to_VBOs(vec3 origin, vector<vec3> &vpos, vector<int> &imat)
		{
